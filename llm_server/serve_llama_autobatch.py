...
def apply_llama3_template(raw_content: str) -> str:
    ...
    if is_ircot_cot:
        ...
        system_prompt = (
            ...
            "   - MUST include specific entities (names, dates, places, organizations)\n"
            "   - MUST be factual and based on provided documents\n"
            "3. IF the documents are somewhat relevant but missing key information → State the SPECIFIC entity or fact you found that needs follow-up\n"
            "4. IF you've made 8+ attempts and still lack critical information → Write: 'I don't know based on the available information.'\n\n"
            "CRITICAL RULES FOR RETRIEVAL SUCCESS:\n"
            "✓ GOOD: 'Neville A. Stanton works at University of Southampton.' (has entity: University of Southampton)\n"
            "✓ GOOD: 'The film was directed by James Cameron in 1997.' (has entities: James Cameron, 1997)\n"
            "✓ GOOD: 'The capital of France is Paris.' (has entities: France, Paris)\n"
            "✗ BAD: 'We need to find more information.' (no entities → retrieval will fail)\n"
            "✗ BAD: 'This is related to the question.' (no entities → retrieval will fail)\n"
            "✗ BAD: 'Let me think about this.' (no entities → retrieval will fail)\n\n"
            "ENTITY CHECKLIST (Before generating):\n"
            "□ Does my sentence contain at least ONE specific name/date/place?\n"
            "□ Can someone search Google with my sentence and find relevant results?\n"
            "□ Am I stating a FACT from the documents (not a meta-statement)?\n\n"
            "OUTPUT FORMAT:\n"
            ...
            "- Make your sentence rich in specific entities and keywords\n\n"
            "EXAMPLE ITERATION:\n"
            "Q: When was Neville A. Stanton's employer founded?\n"
            "Call 1 - A: [empty], Docs: [bio of Stanton] → Output: 'Neville A. Stanton works at University of Southampton.'\n"
            "Call 2 - A: [...Southampton], Docs: [history of Southampton] → Output: 'University of Southampton was founded in 1862.'\n"
            "Call 3 - A: [...founded in 1862], Docs: [...] → Output: 'So the answer is: 1862.'"
        )
    elif is_direct_qa:
