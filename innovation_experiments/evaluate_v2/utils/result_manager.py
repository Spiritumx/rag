"""
Result management for saving/loading intermediate results (V2).

Modified to use outputs_v2 directories for Innovation experiments.
"""
...
class ResultManager:
    """Manage saving/loading of results with resume capability (V2)."""

    def __init__(self, config):
        self.config = config
        self.stage1_dir = config['outputs']['stage1_dir']  # SHARED with baseline
        self.stage2_dir = config['outputs']['stage2_dir']  # SEPARATE: outputs_v2/
        self.stage3_dir = config['outputs']['stage3_dir']  # SEPARATE: outputs_v2/

        # Optional: cascade analysis directory
        self.cascade_dir = config['outputs'].get('cascade_dir', None)
    ...
    def get_stage1_output_path(self, dataset_name: str) -> str:
        """Get path for stage 1 classification results (SHARED with baseline)."""
    ...
    def load_stage1_results(self, dataset_name: str) -> Dict:
        """Load classification results for a dataset (SHARED with baseline)."""
